	...
	let menus: Menu[] = [
		{
			...
			iconStrokes: ['#1A1A1A', '#4D79A7'],
			iconFills: ['transparent', '#1C4966']
		},
		{
			title: 'Learn Craps',
			href: 'learn-craps',
			...
			iconStrokes: ['#1A1A1A', '#4D79A7'], // Black replaced with dark gray, blue toned down
			iconFills: ['none', '#4B8B9B'], // Green toned down to match dark blues
			iconCircles: [
				{ cx: '7.5', cy: '16.5', r: '1.5', fill: '#4B8B9B' }, // Consistent green
				{ cx: '7.5', cy: '7.5', r: '1.5', fill: '#4B8B9B' },
				{ cx: '12', cy: '12', r: '1.5', fill: '#4B8B9B' },
				{ cx: '16.5', cy: '16.5', r: '1.5', fill: '#4B8B9B' },
				{ cx: '16.5', cy: '7.5', r: '1.5', fill: '#4B8B9B' }
			]
		},
		{

<script lang="ts">
	...
	let title: string = 'Betting the Any Seven in Craps';
	...
	let url: string = 'any-seven';

	let phref: string = 'c-and-e';
	let prev: string = 'C & E';
	...
	let tblRows: (string | number)[][] = [['Any 7', '4:1', '7', 'Any other number']];
	let tblPnts: string[] = ['The Any Seven is a one roll bet'];
</script>

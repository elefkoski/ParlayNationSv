...
<LearnLayout {pageLinks}>
	...
	<main aria-label="Main content" class=" flex flex-col my-6">
		...
		<p class="pb-4">
			...
			the 7. The wonderful thing about the Odds bet is THE CASINO HAS ZERO ADVANTAGE, so you should
			always want to make this bet.
		</p>
		...
		<p class="pb-4">
			...
			for a die to land between the two bets. Two dice is a good measure, which is also about the width
			of two fingers.
		</p>
		<ContentImg
			caption=""
		...
		<p class="pb-4">
			When you add Odds to a Pass Line Bet on the 6 or 8, you must bet in increments of five. $5,
			$10, $15, etc. Every $5 you bet as Odds for a Pass Line bet on the 6 or 8 gets paid $6.
			Otherwise known as 6:5, which reads <Quote text="6 to 5" />, or you can think of it as <Quote
				text="$6 for every $5"
			/>.
		</p>
		<ContentImg
		...
		<p class="pb-4">
			It would be best if you had even Odds on the 5 and 9. This means any even number, such as $2,
			$4, $10, $30, etc., could be used. Every $2 you bet as Odds gets paid $3. This is known as
			3:2, which reads, <Quote text="3 to 2" /> or <Quote text="$3 for every $2" />. You could also
			think of this as 1 and ½ times your bet or a Blackjack.
		</p>
		<ContentImg
			caption="Example 1"
		...
		<p class="pb-4">
			Odds on the 4 and 10 can be any amount. Regardless of what you bet, the amount you will win be
			double or 2:1, which reads <Quote text="2 to 1" />, or you can think of it as <Quote
				text="$2 for every $1"
		...
		<p class="pb-4">
			...
			Line bet gets paid even money and the Odds accordingly.
		</p>
		<ContentImg
			caption=""

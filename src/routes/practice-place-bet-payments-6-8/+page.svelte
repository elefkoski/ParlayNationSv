<script lang="ts">
	...
	let title: string = 'Practice Place Bet Payments Payments 6 & 8';
	let description: string =
		'Practice Place Bet Payments Payments on the 6 & 8. Downloadable PDF to practice Craps.';
...
<PracticeLayout>
	<main aria-label="Main content" class=" flex flex-col my-6">
		<PracticeH1 title="Place Bet Payments for the 6 & 8" />
		<div class="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 pb-8">
			<PracticeCarousel {slides} />
			<PracticeDescription
				title="6 & 8 Place Bet Payments"
				description="60 cutout cards meant to practice payments for Place Bets when the Point is 6 or 8. Bets range from $5 up to $1,344. You can cover the answer with your thumb, fold it over, or cut it off."
				listPara="The cards are broken into three difficulties:"
				listItems={['20 Easy', '20 Medium', '20 Hard']}
				downloadUrl="src/pdf/place-bet-payments-6-8.pdf"
			/>
		</div>
